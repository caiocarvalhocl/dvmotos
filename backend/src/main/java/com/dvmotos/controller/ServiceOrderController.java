...
public class ServiceOrderController {
        ...
        public ResponseEntity<ServiceOrderResponse> changeStatus(
                ...
                if (statusStr == null || statusStr.isBlank()) {
                        throw new BusinessException("Campo 'status' é obrigatório");
                }

                ServiceOrderStatus newStatus;
                try {
                        newStatus = ServiceOrderStatus.valueOf(statusStr.toUpperCase());
                } catch (IllegalArgumentException e) {
                        throw new BusinessException("Status inválido: '" + statusStr + "'. Valores aceitos: "
                                        + java.util.Arrays.toString(ServiceOrderStatus.values()));
                }
